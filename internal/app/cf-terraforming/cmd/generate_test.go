...
func TestResourceGenerationV5(t *testing.T) {
	tests := map[string]struct {
		...
		"cloudflare zero trust access ai controls mcp portal":                {identiferType: "account", resourceType: "cloudflare_zero_trust_access_ai_controls_mcp_portal", testdataFilename: "cloudflare_zero_trust_access_ai_controls_mcp_portal"},
		"cloudflare zero trust access ai controls mcp server":                {identiferType: "account", resourceType: "cloudflare_zero_trust_access_ai_controls_mcp_server", testdataFilename: "cloudflare_zero_trust_access_ai_controls_mcp_server"},
